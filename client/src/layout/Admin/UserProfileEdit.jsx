    ...
    return (
        <section className='fixed top-0 right-0 left-0 bottom-0 min-h-screen bg-neutral-900/90 z-50 flex items-center justify-center'>
            ...
            <div>
                ...
                <form onSubmit={handleOnSubmit} className='grid lg:max-w-md lg:min-w-md  md:max-h-[280px] md:min-h-[280px]  md:min-w-[350px] md:max-w-[350px] min-w-[280px] max-w-[280px] max-h-[250px] min-h-[250px] py-2  bg-gradient-to-br from-[#8a909f] to-[#2f3b53] rounded overflow-y-auto  md:px-10 px-6'>
