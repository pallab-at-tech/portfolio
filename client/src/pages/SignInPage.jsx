...
const SignInPage = () => {
  return (
    <section className='min-h-[calc(100vh-32px)] bg-primary-dark text-primary-text extra-font-style md:px-14 pt-[72px]'>
      <div className='container mx-auto bg-gradient-to-br from-[#43547a] to-[#232a36]  max-w-lg p-7 rounded-md mt-16 shadow-md'>
        <form action="" className='grid gap-4 pl-6 py-2 text-[#e3e5ea]'>
        ...
        <p className='pl-6 text-base pt-1 text-sky-50'>Don't have account ? <Link to={"/SignUp"} className='text-blue-300 p-2'>Register</Link></p>
