  ...
  return (
    <section className={`${darkMode ? "bg-primary-black" : "bg-[#e9d6b4]"} ${darkMode ? "text-primary-text" : "text-[#37290b]"} extra-font-style lg:px-20 sm:px-12 px-8 pb-5 pt-6 sm:pt-6 relative`}>
      ...
      <div id='projectID'>
        ...
        <p className={`lg:pl-1 pt-0.5 ${darkMode ? "text-[#c3c7cb]" : "text-[#241a07]"} text-sm pb-8`}>A collection of projects that demonstrate my skills, problem-solving approach, and hands-on experience.</p>
