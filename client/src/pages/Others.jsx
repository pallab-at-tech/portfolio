                                    ...
                                    <div className="overflow-hidden w-full p-3 sm:p-4 lg:p-6">
                                        ...
                                        >
                                            {allOf.all_certificate.map((item) => (
                                                ...
                                                >
                                                    <div
                                                        className={`w-full max-w-[calc(100vw-38px)] sm:max-w-[calc(100vw-70px)] md:max-w-[calc(100vw-100px)] px-[18px] sm:px-6 sm:py-4 py-2.5
                                                        ${darkMode ? "bg-[#38393d] shadow-[inset_1px_-1px_20px_12px_rgb(10,0,10,0.15))] border-2 border-[#1e252fac]"
                                                    ...
                                                    >
                                                        ...
                                                        <div
                                                            className={`mt-2 rounded-2xl w-fit h-fit overflow-hidden bg-gradient-to-br border p-3 sm:p-4
                                                                ...
                                                                ${darkMode ? "from-[#33383ab6] to-[#42413fc3] border-gray-500"
                                                    ...
                                                    <div className="flex gap-4 px-1">
                                                        ...
                                                        {otherData?.data?.map((v, i) => (
                                                            <Link
                                                                ...
                                                                ${darkMode ? "bg-[#38393d] border border-[#1e252fac]"
